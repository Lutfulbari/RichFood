...
def payment(request):
    ...
    store_id: 'richf61784a8b7cac0'

    API_key = 'richf61784a8b7cac0@ssl'

    mypayment = SSLCSession(sslc_is_sandbox=True, sslc_store_id='your_sslc_store_id', sslc_store_pass='API_key')
    ...
    address2=current_user.profile.address1,
